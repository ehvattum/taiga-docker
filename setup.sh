...
sudo docker run -d --name postgres		-e VIRTUAL_HOST=taiga.ragesheep.com -p 5432:5432  			-v /data/postgresql:/var/lib/postgresql/data postgres 
sudo docker run -d --name taiga-back	-e VIRTUAL_HOST=taiga.ragesheep.com -p 8001:8001  			--link postgres:postgres ipedrazas/taiga-back
sudo docker run -d --name taiga-front 	-e VIRTUAL_HOST=taiga.ragesheep.com -p 8002:80 -p 8000:8000 	--link taiga-back:taiga-back ipedrazas/taiga-front
