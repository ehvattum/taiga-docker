...
sudo docker run -d -e VIRTUAL_PORT=5432 -e VIRTUAL_HOST=taiga.ragesheep.com 	--name postgres -v /data/postgresql:/var/lib/postgresql/data postgres 
sudo docker run -d -e VIRTUAL_PORT=8001 -e VIRTUAL_HOST=taiga.ragesheep.com 	--name taiga-back --link postgres:postgres ipedrazas/taiga-back
sudo docker run -d -e VIRTUAL_PORT=80,8000 -e VIRTUAL_HOST=taiga.ragesheep.com 	--name taiga-front --link taiga-back:taiga-back ipedrazas/taiga-front
