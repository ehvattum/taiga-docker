...
sudo docker run -d -e VIRTUAL_PORT=80,8000 -e VIRTUAL_HOST=taiga.ragesheep.com 	-p 8000:8000 --name taiga-front --link taiga-back:taiga-back ipedrazas/taiga-front
